...
- 课件源码库：当前 `src/` 下有 97 个课件目录，其中小学规划内按 ID 直接完成 81 个，初高中两轮规划内已上线 10 个。
...
| 科学 | 22 | 19 | 3 | `plant-xray` 与 `creature-workshop` 已按规划 ID 上线；`plant-lab` 仍是规划外养成实验 |
| 合计 | 84 | 81 | 3 | 另有 11 个规划外已上线课件 |
