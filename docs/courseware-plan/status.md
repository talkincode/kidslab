...
| 逻辑 | 15 | 14 | 1 | P0 已完成；`magic-cube`、`huarong-dao` 为规划外补充 |
| 科学 | 22 | 14 | 8 | `plant-lab` 可能对应 `plant-xray`，但 ID/标题未对齐 |
| 合计 | 84 | 75 | 9 | 另有 11 个规划外已上线课件 |
