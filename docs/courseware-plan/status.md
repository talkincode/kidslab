...
- 课件源码库：当前 `src/` 下有 92 个课件目录，其中小学规划内按 ID 直接完成 78 个。
...
| 科学 | 22 | 16 | 6 | `plant-lab` 可能对应 `plant-xray`，但 ID/标题未对齐 |
| 合计 | 84 | 78 | 6 | 另有 11 个规划外已上线课件 |
