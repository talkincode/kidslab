...
- 课件源码库：当前 `src/` 下有 85 个课件目录，其中小学规划内按 ID 直接完成 74 个。
...
| 逻辑 | 15 | 13 | 2 | P0 已完成；`magic-cube`、`huarong-dao` 为规划外补充 |
| 科学 | 22 | 14 | 8 | `plant-lab` 可能对应 `plant-xray`，但 ID/标题未对齐 |
| 合计 | 84 | 74 | 10 | 另有 10 个规划外已上线课件 |
