...
const I18N = {
  zh: {
    ...
    districtDowntown: '市中心浅蓝区 · {mean} min',
    districtRiverside: '河岸区 · {mean} min',
    districtFactory: '工厂红砖区 · {mean} min',
    districtHill: '山坡绿顶区 · {mean} min',
    welcome: '欢迎来到通勤调查局，点抽样，看这次平均通勤用时准不准。',
    welcomeSkip: '知道了',
  ...
  en: {
    ...
    districtDowntown: 'Downtown cyan · {mean} min',
    districtRiverside: 'Riverside · {mean} min',
    districtFactory: 'Red-brick factory · {mean} min',
    districtHill: 'Green hillside · {mean} min',
    welcome: 'Welcome to the commute survey. Draw a sample and see if this mean commute time is close.',
    welcomeSkip: 'Got it',
