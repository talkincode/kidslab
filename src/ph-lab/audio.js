  ...
  function beep(kind = 'tap') {
    ...
    try {
      ...
      const settings = {
        ...
        pour: { notes: [330, 262], type: 'sine', gain: 0.07, duration: 0.28 },
        drop: { notes: [784, 988], type: 'triangle', gain: 0.06, duration: 0.16 },
        bound: { notes: [440, 554], type: 'sine', gain: 0.07, duration: 0.2 },
